			...
			<div id="img">
				<div class="imgbox">
				    <div class="imgnum">
				        ...
				        <img src="${ctx }/${oemName}/images/sfz.png" class="img1" />
				        <img id="${ctx }/${oemName}/uploadCenterImg_Path" src="" class="img2" />
				    </div>
				</div>
			</div>
			<span>身份证正面照</span>
			...
			<div id="img">
				<div class="imgbox">
				    <div class="imgnum">
				        ...
				        <img src="${ctx }/${oemName}/images/yhk.png" class="img1" />
				        <img id="${ctx }/${oemName}/uploadCardImg_Path" src="" class="img2" />
				    </div>
				</div>
			</div>
			<span>银行卡正面照</span>
