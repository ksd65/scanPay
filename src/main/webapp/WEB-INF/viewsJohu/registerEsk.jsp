	...
	<div class="zcimsdiv">
		<div class="zcimscon">
			...
			<dl>
				...
				<em></em>
				<div class="setsa">
					<select name="city" onchange="cityChange(this.value,this)">
					<option value="">市/县</option>
					</select>
				</div>
			</dl>
			<input type="hidden" id="bankArea" name="bankArea" value="">
			<dl>
				<span>开户银行</span>
				<div class="setsb">
					<select name="bankId">
	...
	$.ajaxFileUpload ({ 
    	...
    	success: function (data, status){ 
		    	if(data.returnCode == "0000"){ 
		    		var filePath = data.resData.filePath;alert(filePath)
