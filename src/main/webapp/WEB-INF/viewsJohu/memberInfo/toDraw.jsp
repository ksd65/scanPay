...
<div class="txbig">
	...
	<ul class="txflul">
		<li>
			<dd><img src="${ctx }/johu/images/wx.png" /><span>微信</span></dd>
			<dd>
				<b>￥${resData.unDrawMoneyCountWx}</b>
				<p>未提现金额</p>
			</dd>
			<a href="javascript:;" onclick="doDraw(1)">立即提现</a>
		</li>
		<li>
			<dd><img src="${ctx }/johu/images/zfb.png" /><span>支付宝</span></dd>
			<dd>
				<b>￥${resData.unDrawMoneyCountZfb}</b>
				<p>未提现金额</p>
			</dd>
			<a href="javascript:;" onclick="doDraw(2)">立即提现</a>
		</li>
		<li>
			<dd><img src="${ctx }/johu/images/qq.png" /><span>QQ钱包</span></dd>
			<dd>
				<b>￥${resData.unDrawMoneyCountQq}</b>
				<p>未提现金额</p>
			</dd>
			<a href="javascript:;" onclick="doDraw(3)">立即提现</a>
		</li>
		<li>
			<dd><img src="${ctx }/johu/images/bd.png" /><span>百度钱包</span></dd>
			<dd>
				<b>￥${resData.unDrawMoneyCountBd}</b>
				<p>未提现金额</p>
			</dd>
			<a href="javascript:;" onclick="doDraw(4)">立即提现</a>
		</li>
		<li>
