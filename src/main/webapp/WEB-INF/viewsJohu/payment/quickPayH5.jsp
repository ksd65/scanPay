...
<div id="container">
	...
	<div class="jydivtop">
		...
		<div class="jybz">
			<span>银行卡号</span>
			<input type="text" class="bzxx" id="bankAccountT" name="bankAccountT"/>
		</div> 
		<div class="jybz">
			<span>预留手机号</span>
			<input type="text" class="bzxx" id="telT" name="telT"/>
		</div> 
	</div>
	<div class="buttons">
		<div class="butleft">
...
<form id="form" action="${ctx }/payment/quickPayH5Confirm" method="post">
