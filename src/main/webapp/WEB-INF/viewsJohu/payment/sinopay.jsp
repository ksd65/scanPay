...
<form name="pay" method="post" action="${ctx}/payment/toPayment" id="pay" target="_blank">
    ...
    <!--    <tr>
        ...
        <tr>
            <td>订单金额(*)</td>
            <td><input id="payMoney" name="payMoney" size="16" value="${payMoney }" type="text" readonly="readonly"></td>
        </tr>
     <!--    <tr>
            <td>订单日期(*)</td>
   ...
   <!--     <tr>
        ...
        <tr>
            <td>商品名称</td>
            <td><input id="goodsName" name="goodsName" size="16" value="${goodsName }" type="text"></td>
        </tr>
     <!--   <tr>
            <td>订单有效期(小时为单位)</td>
